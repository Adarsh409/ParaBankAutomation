...
const bddFileData = [ // bdd-data-start
  {"pwTestLine":6,"pickleLine":3,"tags":[],"steps":[{"pwStepLine":7,"gherkinStepLine":4,"keywordType":"Context","textWithKeyword":"Given User launches the application","stepMatchArguments":[]},{"pwStepLine":8,"gherkinStepLine":5,"keywordType":"Action","textWithKeyword":"When User clicks the Register link","stepMatchArguments":[]},{"pwStepLine":9,"gherkinStepLine":6,"keywordType":"Action","textWithKeyword":"And User enters the following registration details:","stepMatchArguments":[]},{"pwStepLine":10,"gherkinStepLine":17,"keywordType":"Action","textWithKeyword":"And User clicks Register button","stepMatchArguments":[]},{"pwStepLine":11,"gherkinStepLine":18,"keywordType":"Outcome","textWithKeyword":"Then Sucess message should be displayed","stepMatchArguments":[]},{"pwStepLine":12,"gherkinStepLine":19,"keywordType":"Action","textWithKeyword":"When User logs out of the application","stepMatchArguments":[]},{"pwStepLine":13,"gherkinStepLine":20,"keywordType":"Action","textWithKeyword":"And User logs in with newly created credentials","stepMatchArguments":[]},{"pwStepLine":14,"gherkinStepLine":21,"keywordType":"Outcome","textWithKeyword":"Then Account dashboard should be visible","stepMatchArguments":[]}]},
]; // bdd-data-end